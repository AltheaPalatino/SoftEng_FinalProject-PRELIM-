<?php
require_once __DIR__ . '/dbConfig.php'; // this loads your global $pdo

class Database {
    protected $pdo;

    public function __construct() {
        // use the global $pdo defined in dbConfig.php
        global $pdo;
        $this->pdo = $pdo;
    }
...
// EXCUSE LETTER
function updateExcuseStatus($pdo, $excuse_id, $status) {
...
// Fetch all excuse letters with student info
function getAllExcuseLetters($pdo) {
