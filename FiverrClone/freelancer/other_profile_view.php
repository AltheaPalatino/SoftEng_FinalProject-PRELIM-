                ...
                <form action="core/handleForms.php" method="POST">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="contact_number" value="<?= htmlspecialchars($userInfo['contact_number']); ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label>Bio</label>
                      <textarea name="bio_description" class="form-control" disabled><?= htmlspecialchars($userInfo['bio_description']); ?></textarea>
                    </div>  
                  </div>
                </form>
              </div>
